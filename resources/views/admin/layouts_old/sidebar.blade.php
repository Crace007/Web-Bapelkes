<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link {{Request::is('admin/trainingschedule*') ? 'active' : ''}}" href="/admin/trainingschedule">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link {{Request::is('admin/desain*') ? 'active' : ''}}" aria-current="page" href="/admin/desain">
            <span data-feather="info"></span>
            new design
          </a>
        </li>
