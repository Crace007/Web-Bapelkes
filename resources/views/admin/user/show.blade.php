  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col">
            @if (isset($data->photo_profile))
              <img src="{{asset('storage/'.$data->photo_profile)}}" class="rounded-circle img-fuild mx-auto d-block" style="object-fit: cover; object-position: 100% 0" width="150" height="150">
            @else  
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form id="tesFormModal" method="POST" enctype="multipart/form-data" >
                  ...
                  <input type="hidden" name="photoProfile_old" value="{{ $data->photo_profile }}">
        ...
        @if (isset($data->about))
            <p class="text-center">"{{strip_tags($data->about)}}"</p>
        @endif
      </div>
    </div>
    <div class="row mt-2">
      <div class="col-md-4">
        <div class="row mb-1">
          ...
          <div class="col">
            <div class="d-flex flex-row-reverse">
              <a href="/admin/users/{{$data->slug}}/edit" class="btn btn-primary btn-sm"><span data-feather="edit-2"></span> Edit</a>
            </div>
          </div>
        </div>
        <div class="col mb-2">
            ...
            <div class="card-body">
              <table>
                ...
                <tr>
                  <td>TTL</td>
                  <td>:</td>
                  <td>{{$data->tempat_lahir}}, {{ tanggal_id($data->tanggal_lahir) }}</td>
                </tr>
                <tr>
                  <td>Jenis Kelamin</td>
                  <td>:</td>
        ...
        <div class="row mb-1">
          ...
          <div class="col">
            <div class="d-flex flex-row-reverse">
              ...
              @else
                <a href="/admin/employees/{{$data->employee_id}}/edit" class="btn btn-primary btn-sm"><span data-feather="edit-2"></span> Edit</a>
              @endif
            </div>
          </div>
        </div>
        @if ( $data->status_pekerjaan === 'ASN' )
        <div class="col mb-2">
          <div class="card">
            <div class="card-body">
              @if ($pegawai === null)
