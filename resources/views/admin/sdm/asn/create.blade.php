...
<div class="col-lg-8">
    <form method="post" action="/admin/employees" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <select class="form-select" name="pangkat_id" required>
            <option value="{{null}}">-- SELECT ONE --</option>
              @foreach ($rankcategories as $category)
                @if (old('pangkat_id') == $category->id)
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control @error('tanggal_pangkat') is-invalid @enderror " id="tanggal_pangkat" name="tanggal_pangkat" value="{{old('tanggal_pangkat')}}" required>
        ...
        <div class="row">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="number" class="form-control @error('masaKerja_thn') is-invalid @enderror " id="masaKerja_thn" name="masaKerja_thn" value="{{old('masaKerja_thn')}}" required>
              @error('masaKerja_thn')
                  <div class="invalid-feedback">
                    {{$message}}
                  </div>
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="number" class="form-control @error('masaKerja_bln') is-invalid @enderror " id="masaKerja_bln" name="masaKerja_bln" value="{{old('masaKerja_bln')}}" required>
              @error('masaKerja_bln')
                  <div class="invalid-feedback">
                    {{$message}}
                  </div>
        ...
        <div class="row">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('latihanJabatan_diklat') is-invalid @enderror " id="latihanJabatan_diklat" name="latihanJabatan_diklat" value="{{old('latihanJabatan_diklat')}}">
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('latihanJabatan_tahun') is-invalid @enderror " id="latihanJabatan_tahun" name="latihanJabatan_tahun" value="{{old('latihanJabatan_tahun')}}">
