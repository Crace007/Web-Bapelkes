...
<div class="pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 mb-2">Create New Jadwal Pelatihan</h1>
    <a href="/admin/trainingschedule" class="link-secondary"><span data-feather="arrow-left"></span> Back to data pelatihan</a>
</div>

<div class="col-lg-8">
    <form method="post" action="/admin/trainingschedule" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
          <label for="nama_pelatihan" class="form-label">Nama Pelatihan</label>
          <input type="text" class="form-control @error('nama_pelatihan') is-invalid @enderror " id="title" name="nama_pelatihan" value="{{old('nama_pelatihan')}}" required autofocus >
        ...
        <div class="mb-3">
            <div class="row">
                <div class="col">
                    ...
                    <input type="date" class="form-control @error('tanggal_start') is-invalid @enderror " id="tanggal_start" name="tanggal_start" value="{{old('tanggal_start')}}" required >
                    @error('tanggal_start')
                        <div class="invalid-feedback">
                          {{$message}}
                        </div>
                ...
                <div class="col">
                    ...
                    <input type="date" class="form-control @error('tanggal_end') is-invalid @enderror " id="tanggal_end" name="tanggal_end" value="{{old('tanggal_end')}}" required >
                    @error('tanggal_end')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
        ...
        <div class="mb-3">
            <div class="row">
                <div class="col">
                    ...
                    <input type="number" class="form-control @error('lama_jpl') is-invalid @enderror" id="lama_jpl" name="lama_jpl" value="{{old('lama_jpl')}}" required >
                    @error('lama_jpl')
                        <div class="invalid-feedback">
                          {{$message}}
                        </div>
                ...
                <div class="col">
                    ...
                    <input type="number" class="form-control @error('lama_hari') is-invalid @enderror" id="lama_hari" name="lama_hari" value="{{old('lama_hari')}}" required >
                    @error('lama_hari')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('metode') is-invalid @enderror " id="metode" name="metode" value="{{old('metode')}}" required >
            @error('metode')
                <div class="invalid-feedback">
                  {{$message}}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('instansi_penyelenggara') is-invalid @enderror " id="instansi_penyelenggara" name="instansi_penyelenggara" value="{{old('instansi_penyelenggara')}}" required >
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('tempat_penyelenggaraan') is-invalid @enderror " id="tempat_penyelenggaraan" name="tempat_penyelenggaraan" value="{{old('tempat_penyelenggaraan')}}" required >
            ...
            <select class="form-select" name="pengendaliPelatihan_id">
              <option value="{{null}}">-- SELECT ONE --</option>
                @foreach ($data as $item)
                  @if (old('pengendaliPelatihan_id') == $item->id)
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="penanggungJawab_id">
              <option value="{{null}}">-- SELECT ONE --</option>
                @foreach ($data as $item)
                  @if (old('penanggungJawab_id') == $item->id)
                    <option value="{{$item->id}}" selected> {{$item->user->name}} </option>
                  @else
                    <option value="{{$item->id}}"> {{$item->user->name}} </option>
                  @endif
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="ketuaPanitia_id">
              <option value="{{null}}">-- SELECT ONE --</option>
                @foreach ($data as $item)
                  @if (old('ketuaPanitia_id') == $item->id)
                    <option value="{{$item->id}}" selected> {{$item->user->name}} </option>
                  @else
                    <option value="{{$item->id}}"> {{$item->user->name}} </option>
                  @endif
