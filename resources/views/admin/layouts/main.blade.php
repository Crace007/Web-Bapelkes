    ...
    <script type="text/javascript">
      ...
      function previewImage(){
        ...
        oFReader.onload =  function(oFREvent){
          ...
          imgPreview.style = "object-fit: cover; object-position: 100% 0"
        }
      }
      ...
      function ResetModal(){
        ...
        document.getElementById("tesFormModal").reset();
        
        imgPreview.src = "{{ asset('storage/default_image/noimg.jpg') }}";
      }    
      ...
      function uploadProfile(){
        ...
        $("#btn_SavePhotoProfile").addClass("disabled");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#btn_SavePhotoProfile").removeClass("disabled");
                $('#fotoprofileModal').modal('hide');
