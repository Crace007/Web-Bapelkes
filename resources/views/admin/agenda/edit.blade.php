...
<div class="pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 mb-2">Ubah Agenda</h1>
    <a href="/admin/agenda" class="link-secondary"><span data-feather="arrow-left"></span> Kembali ke List Agenda</a>
</div>

<div class="col-lg-8">
    <form method="post" action="/admin/agenda/{{$data->slug}}" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="mb-3">
        ...
        <div class="mb-3">
          <div class="row">
            <div class="col">
              ...
              <input type="datetime-local" class="form-control @error('tanggal_mulai') is-invalid @enderror" id="tanggal_mulai" name="tanggal_mulai" value="{{old('tanggal_mulai', $data->tanggal_mulai)}}" required >
              @error('tanggal_mulai')
                  <div class="invalid-feedback">
                    {{$message}}
                  </div>
            ...
            <div class="col">
              ...
              <input type="datetime-local" class="form-control @error('tanggal_selesai') is-invalid @enderror" id="tanggal_selesai" name="tanggal_selesai" value="{{old('tanggal_selesai', $data->tanggal_selesai)}}" required >
        ...
        <div class="mb-3">
            ...
            <div class="card p-2">
              <input type="hidden" name="body" id="body" value="{{ old('body', $data->body) }}">
        ...
        <div class="text-end">
          <button type="submit" class="btn btn-primary mb-3">Ubah Agenda</button>
        </div>
      </form>
</div>
